...
namespace _06_24InformationSystem
{
    public partial class MainView : Form
    {
        ...
        // Lists
        List<Logged> loggedList = new List<Logged>();
        List<Unlogged> unloggedList = new List<Unlogged>();
        ...
        private void actionCheckListbox_SelectedIndexChanged(object sender, EventArgs e)
        {
        }
